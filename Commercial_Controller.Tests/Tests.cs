...
namespace Commercial_Controller.Tests
{
    ...
    public class UnitTest1
    {
        ...
        public void TestScenario1()
        {
            ...
            Assert.AreEqual(expectedColumn.ID, chosenColumn.ID, "Wrong column selected, expected Column " + expectedColumn.ID + ", got Column " + chosenColumn.ID);

            Assert.AreEqual(expectedElevator.ID, chosenElevator.ID, "Wrong elevator selected, expected Elevator {0}, got Elevator {1}", expectedElevator.ID, chosenElevator.ID);
